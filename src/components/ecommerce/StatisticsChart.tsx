...
export default function StatisticsChart() {
  ...
  return (
    <div className="rounded-2xl border border-gray-200/80 bg-white px-5 pb-5 pt-5 shadow-theme-sm transition-all duration-500 ease-out hover:-translate-y-0.5 hover:shadow-premium dark:border-white/10 dark:bg-white/[0.03] sm:px-6 sm:pt-6">

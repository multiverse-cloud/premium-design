    ...
    <ComponentCard title="Modal Based Alerts">
      <div className="flex flex-wrap items-center gap-3">
        ...
        <Button
          ...
          className="bg-gradient-to-r from-blue-light-500 to-blue-light-600"
        >
          Info Alert
        </Button>
        <Button
          ...
          className="bg-gradient-to-r from-warning-500 to-warning-600"
        >
          Warning Alert
        </Button>
        <Button
          ...
          className="bg-gradient-to-r from-error-500 to-error-600"
        >
          Danger Alert
        </Button>
      </div>

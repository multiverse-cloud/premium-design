...
export default function FullScreenModal() {
  ...
  return (
    <ComponentCard title="Full Screen Modal">
      <Button size="md" variant="gradient" onClick={openFullscreenModal}>
        Open Modal
      </Button>
      <Modal
        isOpen={isFullscreenModalOpen}
      ...
      >
        <div className="fixed top-0 left-0 flex flex-col justify-between w-full h-screen p-6 overflow-x-hidden overflow-y-auto bg-white dark:bg-gray-900 lg:p-10">
          <div>
            <h4 className="font-bold text-gray-900 mb-7 text-2xl dark:text-white">
              Modal Heading
            </h4>
          ...
          <div className="flex items-center justify-end w-full gap-3 mt-8">
            <Button size="md" variant="outline" onClick={closeFullscreenModal}>
              Close
            </Button>
